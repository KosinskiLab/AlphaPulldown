...
class PDBAnalyser:
    ...
    def retrieve_C_beta_coords(self, chain_df: pd.DataFrame) -> pd.DataFrame:
        """
        ...
        Return:
            a pandas dataframe of all C-beta atoms
        Note:
        Will retrieve C-alpha atom coords if the residue is a glycine
        """
        return chain_df.loc[(chain_df['atom_name'] == 'CB') or ((chain_df['residue_name'] == 'GLY') and (chain_df['atom_name'] == 'CA'))]
